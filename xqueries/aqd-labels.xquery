...
declare variable $labels:D37b := labels:getDefinition("D37");
declare variable $labels:D37b_SHORT := labels:getPrefLabel("D37");
declare variable $labels:D37a := labels:getDefinition("D37b");
declare variable $labels:D37a_SHORT := labels:getPrefLabel("D37b");
