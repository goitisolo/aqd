...
let $E34func := function() {
    ...
    for $sample in $previousData[sparql:binding[@name = "SamplingPointLocalId"]/sparql:literal = $samplingPoint]

    let $previousMean := $sample/sparql:binding[@name = "AQValue"]/sparql:literal/string() => number()
