...
<!-- $Id$
    AQ attainment business data 7 - Final exceedance area description using administrative geographies
...
<xsl:template name="header">
    ...
    <xsl:text>AdministrativeUnit</xsl:text><xsl:text>&nl;</xsl:text>
</xsl:template>
...
<xsl:template name="row">
    ...
    <xsl:call-template name="wrapext">
      <xsl:with-param name="value" select="aqd:exceedanceDescriptionFinal/aqd:ExceedanceDescription/aqd:exceedanceArea/aqd:ExceedanceArea/aqd:administrativeUnit/@xlink:href"/>
    </xsl:call-template>
