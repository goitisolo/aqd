...
<!-- $Id$
    AQ attainment business data 5 - Preliminary exceedance area description using administrative geographies
...
<xsl:template name="row">
    ...
    <xsl:call-template name="wrapext">
      <xsl:with-param name="value" select="aqd:exceedanceDescriptionPreliminary/aqd:ExceedanceDescription/aqd:exceedanceArea/aqd:ExceedanceArea/aqd:administrativeUnit/@xlink:href"/>
    </xsl:call-template>
