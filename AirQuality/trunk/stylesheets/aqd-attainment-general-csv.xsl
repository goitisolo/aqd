...
<!-- $Id$
    AQ attainment business data 1 - General AQ pollutant & environmental objective information for the attainment declaration
...
<xsl:template name="header">
    ...
    <xsl:text>Assessment</xsl:text><xsl:text>&nl;</xsl:text>
</xsl:template>
...
<xsl:template name="row">
    ...
    <xsl:call-template name="wrapext">
      <xsl:with-param name="value" select="aqd:assessment/@xlink:href"/>
    </xsl:call-template>
