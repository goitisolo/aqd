...
declare variable $labels:VOCABALL := labels:getDefinition("VOCABALL");
declare variable $labels:VOCABALL_SHORT := labels:getPrefLabel("VOCABALL");
declare variable $labels:TIMINGTABLEHEADER := "Processing times of QC checks are listed here for the sole purpose of further improvements of the EE's QC system. They do not have any importance for interpretation of results of the data quality checks.";
...
declare variable $labels:B11b := labels:getDefinition("B11b");
declare variable $labels:B11b_SHORT := labels:getPrefLabel("B11b");
declare variable $labels:B12 := labels:getDefinition("B12");
declare variable $labels:B12_SHORT := labels:getPrefLabel("B12");
declare variable $labels:B12b := labels:getDefinition("B12b");
declare variable $labels:B12b_SHORT := labels:getPrefLabel("B12b");
...
declare variable $labels:D03c := labels:getDefinition("D03c");
declare variable $labels:D03c_SHORT := labels:getPrefLabel("D03c");
...
declare variable $labels:D25 := labels:getDefinition("D25");
declare variable $labels:D25_SHORT := labels:getPrefLabel("D25");
...
declare variable $labels:D37b := labels:getDefinition("D37b");
declare variable $labels:D37b_SHORT := labels:getPrefLabel("D37b");
declare variable $labels:D37a := labels:getDefinition("D37a");
declare variable $labels:D37a_SHORT := labels:getPrefLabel("D37a");
...
declare variable $labels:D49 := labels:getDefinition("D49");
declare variable $labels:D49_SHORT := labels:getPrefLabel("D49");
...
declare variable $labels:E19c := labels:getDefinition("E19c");
declare variable $labels:E19c_SHORT := labels:getPrefLabel("E19c");
...
declare variable $labels:E23b := labels:getDefinition("E23b");
declare variable $labels:E23b_SHORT := labels:getPrefLabel("E23b");
declare variable $labels:E24 := labels:getDefinition("E24");
declare variable $labels:E24_SHORT := labels:getPrefLabel("E24");
declare variable $labels:E24b := labels:getDefinition("E24b");
declare variable $labels:E24b_SHORT := labels:getPrefLabel("E24b");
...
declare variable $labels:E35 := labels:getDefinition("E35");
declare variable $labels:E35_SHORT := labels:getPrefLabel("E35");
...
declare variable $labels:Eb46 := labels:getDefinition("Eb46");
declare variable $labels:Eb46_SHORT := labels:getPrefLabel("Eb46");
declare variable $labels:Eb47 := labels:getDefinition("Eb47");
declare variable $labels:Eb47_SHORT := labels:getPrefLabel("Eb47");
declare variable $labels:Eb48 := labels:getDefinition("Eb48");
declare variable $labels:Eb48_SHORT := labels:getPrefLabel("Eb48");
declare variable $labels:Eb49 := labels:getDefinition("Eb49");
declare variable $labels:Eb49_SHORT := labels:getPrefLabel("Eb49");
declare variable $labels:Eb50a := labels:getDefinition("Eb50a");
declare variable $labels:Eb50a_SHORT := labels:getPrefLabel("Eb50a");
declare variable $labels:Eb50b := labels:getDefinition("Eb50b");
declare variable $labels:Eb50b_SHORT := labels:getPrefLabel("Eb50b");
...
declare variable $labels:G91 := labels:getDefinition("G91");
declare variable $labels:G91_SHORT := labels:getPrefLabel("G91");
...
declare variable $labels:I12a := labels:getDefinition("I12a");
declare variable $labels:I12a_SHORT := labels:getPrefLabel("I12a");
