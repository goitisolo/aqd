...
declare variable $labels:B1 := labels:getDefinition("B1");
declare variable $labels:B1_SHORT := labels:getPrefLabel("B1");
declare variable $labels:B2 := labels:getDefinition("B2");
declare variable $labels:B2_SHORT := labels:getPrefLabel("B2");
declare variable $labels:B3 := labels:getDefinition("B3");
declare variable $labels:B3_SHORT := labels:getPrefLabel("B3");
declare variable $labels:B4 := labels:getDefinition("B4");
declare variable $labels:B4_SHORT := labels:getPrefLabel("B4");
declare variable $labels:B5 := labels:getDefinition("B5");
declare variable $labels:B5_SHORT := labels:getPrefLabel("B5");
declare variable $labels:B6a := labels:getDefinition("B6a");
declare variable $labels:B6a_SHORT := labels:getPrefLabel("B6a");
declare variable $labels:B6b := labels:getDefinition("B6b");
declare variable $labels:B6b_SHORT := labels:getPrefLabel("B6b");
declare variable $labels:B7 := labels:getDefinition("B7");
declare variable $labels:B7_SHORT := labels:getPrefLabel("B7");
declare variable $labels:B8 := labels:getDefinition("B8");
declare variable $labels:B8_SHORT := labels:getPrefLabel("B8");
declare variable $labels:B9 := labels:getDefinition("B9");
declare variable $labels:B9_SHORT := labels:getPrefLabel("B9");
